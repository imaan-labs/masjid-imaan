        ...
        <div className="relative pt-32 pb-10 md:pt-20 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              And if they knew the reward of Isha and Fajr prayers in
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <Link
                  className="btn text-white bg-gold-700 hover:bg-gold-800 w-full mb-4 sm:w-auto sm:mb-0 ml-4"
                  href="/#donate"
                >
                  Donate
                </Link>
          ...
          <div className="w-full">
            <a
              data-masjidbox-widget="WjjD3Si6J5VrcifLOekhu"
              data-masjidbox-ifr
              // TODO: config ~ move this to a config
              href="https://masjidbox.com/prayer-times/imaan"
              target="_blank"
            >
              Salah Timings
            </a>
