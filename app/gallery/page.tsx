...
export default function GalleryPage() {
  ...
  const gallery: GalleryData[] = [
    ...
    { name: "/images/menbluecarpet1.jpg", categories: ["Masjid"] },
    { name: "/images/menbluecarpet2.jpg", categories: ["Masjid"] },
    ...
    { name: "/images/bbq3.jpg", categories: ["Events","Community","Recreation Center"] },
    { name: "/images/parking3.jpg", categories: ["Location"] },
    ...
    { name: "/images/sistersraw.jpg", categories: ["Masjid"] },
    ...
    { name: "/images/jointeid2024.jpg", categories: ["Flyers"] }
  ];
